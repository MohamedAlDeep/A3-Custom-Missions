...
force ace_repair_fullRepairRequiredItems = ["ace_repair_anyToolKit", "vn_b_item_toolkit"];
force ace_repair_locationsBoostTraining = false;
force ace_repair_miscRepairRequiredItems = ["ace_repair_anyToolKit", "vn_b_item_toolkit"];
...
force CBRN_factionMask_USAF = "";
force CBRN_factionMask_USAF_ServiceMenu = "";
